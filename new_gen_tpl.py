...
def generate_random_tpl(
    filename, user_given_number_of_populations, user_given_sample_sizes
):
    # Step 1 ✓
...
generate_random_tpl(
    filename="tpl_test.tpl",
    user_given_number_of_populations=4,
    user_given_sample_sizes=[2, 1, 1, 3],
)
